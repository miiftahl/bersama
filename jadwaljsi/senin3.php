...
<head>
	...
	<meta http-equiv="Refresh" content="60;url=senin4.php">
...
<ul>
	...
	<a href="senin1.php"><button type="button" class="btn btn-info">SENIN</button></a>
	...
	<thead>
		...
		<?php 
		include "koneksi.php";
		$query_mysql = mysql_query("SELECT * FROM senin3")or die(mysql_error());
		$nomor = 1;
