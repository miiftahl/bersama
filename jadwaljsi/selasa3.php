...
<head>
	...
	<meta http-equiv="Refresh" content="60;url=selasa4.php">
...
<ul>
	...
	<thead>
		...
		<?php 
		include "koneksi.php";
		$query_mysql = mysql_query("SELECT * FROM selasa3")or die(mysql_error());
		$nomor = 1;
		...
		<h2>SESI : <span class="blink_text"><font color="red"><strong>3</strong></font></span></h2>		
