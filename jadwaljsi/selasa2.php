...
<head>
	...
	<meta http-equiv="Refresh" content="60;url=selasa3.php">
...
<ul>
	...
	<a href="selasa1.php"><button type="button" class="btn btn-info">SELASA</button></a>
	...
	<thead>
		...
		<?php 
		include "koneksi.php";
		$query_mysql = mysql_query("SELECT * FROM selasa2")or die(mysql_error());
		$nomor = 1;
		...
		<h2>SESI : <span class="blink_text"><font color="red"><strong>2</strong></font></span></h2>		
