...
<head>
	...
	<meta http-equiv="Refresh" content="60;url=selasa1.php">
...
<ul>
	...
	<thead>
		...
		<?php 
		include "koneksi.php";
		$query_mysql = mysql_query("SELECT * FROM selasa4")or die(mysql_error());
		$nomor = 1;
		...
		<h2>SESI : <span class="blink_text"><font color="red"><strong>4</strong></font></span></h2>		
