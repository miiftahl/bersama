...
<head>
	...
	<meta http-equiv="Refresh" content="60;url=jumat1.php">
...
<ul>
	...
	<a href="jumat1.php"><button type="button" class="btn btn-info">JUMAT</button></a>
	<div class="row">
	...
	<thead>
		...
		<?php 
		include "koneksi.php";
		$query_mysql = mysql_query("SELECT * FROM jumat4")or die(mysql_error());
		$nomor = 1;
